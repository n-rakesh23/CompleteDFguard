# ============================================================
# Networking Module
# Creates: VPC, Public Subnets (2 AZs), IGW, Route Table,
...
resource "aws_security_group" "ec2" {
  ...
  description = "DFGuard EC2 app server — allow SSH, HTTP, HTTPS"
  vpc_id      = aws_vpc.main.id
  ...
  # HTTP — Nginx listens here, redirects to HTTPS
  ingress {
    from_port   = 80
    to_port     = 80
    protocol    = "tcp"
  ...
  # Node.js direct (for health checks and debugging only)
  ingress {
    from_port   = 8000
    to_port     = 8000
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"]
    description = "Node.js API direct access"
  }
